...
console.log('NOTE: this proves asset routing only. Full sprint acceptance still requires a user-authorized round trip, evidenced local return proving, deployed Compact USDM settlement, and correlated receipts. Asset routing proves none of those live outcomes.')