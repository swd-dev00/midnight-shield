...
class _Either_1 {
  alignment() {
    return _descriptor_3.alignment().concat(_descriptor_6.alignment().concat(_descriptor_2.alignment()));
  }
  fromValue(value_0) {
    return {
      is_left: _descriptor_3.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_3.toValue(value_0.is_left).concat(_descriptor_6.toValue(value_0.left).concat(_descriptor_2.toValue(value_0.right)));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      settle: (...args_1) => {
        ...
        const settlementId_0 = args_1[1];
        const amount_0 = args_1[2];
        const recipient_0 = args_1[3];
        const memoHash_0 = args_1[4];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('settle',
                                     'argument 1 (as invoked from Typescript)',
                                     'usdm-settlement.compact line 39 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(settlementId_0.buffer instanceof ArrayBuffer && settlementId_0.BYTES_PER_ELEMENT === 1 && settlementId_0.length === 32)) {
          __compactRuntime.typeError('settle',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(settlementId_0).concat(_descriptor_1.toValue(amount_0).concat(_descriptor_2.toValue(recipient_0).concat(_descriptor_0.toValue(memoHash_0)))),
    ...
    this.impureCircuits = { settle: this.circuits.settle };
    this.provableCircuits = { settle: this.circuits.settle };
  }
  initialState(...args_0) {
    if (args_0.length !== 2) {
    ...
    if (!(_usdmColor_0.buffer instanceof ArrayBuffer && _usdmColor_0.BYTES_PER_ELEMENT === 1 && _usdmColor_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'usdm-settlement.compact line 27 char 1',
                                 'Bytes<32>',
                                 _usdmColor_0)
    }
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(0n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(_usdmColor_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _settle_0(context,
            ...
            memoHash_0)
  {
    const publicId_0 = settlementId_0;
    const publicAmount_0 = amount_0;
    const publicRecipient_0 = recipient_0;
    const publicMemoHash_0 = memoHash_0;
    __compactRuntime.assert(publicAmount_0 > 0n,
                           ...
                           _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                     ...
                                                                                     [
                                                                                      ...
                                                                                      { popeq: { cached: false,
                                                                                                 result: undefined } }]).value),
                           publicAmount_0,
                           this._right_0(publicRecipient_0));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(publicId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(publicAmount_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(publicId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(publicRecipient_0),
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(publicId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(publicMemoHash_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_0 = 1n;
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'usdm-settlement.compact line 22 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    settlementRecipients: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'usdm-settlement.compact line 23 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    settlementMemoHashes: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'usdm-settlement.compact line 24 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
